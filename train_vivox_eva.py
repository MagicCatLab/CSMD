...
from models.vox_vit_depth_eva import Vox_vit_depth_eva
...
def parse_args():
    ...
    #                     help='Config yaml file')
    parser.add_argument('--config_file', default='./configs/vivox_ddp/ddad_surround_fusion_eva.yaml', type=str,
                        help='Config yaml file')
...
def train(cfg, args, rank):
    ...
    if ab_model == 'vf_fusion':
        print("---------------vf_fusion---------------")
        trainer = Vox_vit_depth_eva(cfg, rank,gpu_id)
        return trainer
...
if __name__=="__main__":
    ...
    s = './data/disk3/depth_all_save/ddad_good/scene_all_150_200'
    trainer.evaluate(save_root=s, save_del=True,save_pred=True)
