...
from models.vox_decoder_depth_ddp import Vox_decoder_depth_ddp
...
def parse_args():
    ...
    parser.add_argument('--config_file', default='./configs/vivox_decoder_ddp/ddad_surround_fusion_ddp.yaml', type=str,
...
def train(cfg, args, rank):
    ...
    if ab_model == 'vf_fusion':
        print("---------------vf_fusion---------------")
        trainer = Vox_decoder_depth_ddp(cfg, rank)
        return trainer
