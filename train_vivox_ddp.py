...
from models.vox_vit_depth_ddp import Vox_vit_depth_ddp
...
def parse_args():
    ...
    parser.add_argument('--config_file', default='./configs/vivox_ddp/ddad_surround_fusion_ddp.yaml', type=str,
                        help='Config yaml file')
...
def train(cfg, args, rank):
    ...
    if ab_model == 'vf_fusion':
        print("---------------vf_fusion---------------")
        trainer = Vox_vit_depth_ddp(cfg, rank)
        return trainer
